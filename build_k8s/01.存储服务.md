...
# 把秘钥上传到服务器上并重新运行
sudo docker run --name web -p 80:80 -p 443:443 -d -v /home/xiaoyou/nginx/nginx.conf:/etc/nginx/nginx.conf -v  /home/xiaoyou/nginx/ca:/etc/nginx/ca 192.168.1.60:8001/nginx
# 然后再修改一下反向代理服务
